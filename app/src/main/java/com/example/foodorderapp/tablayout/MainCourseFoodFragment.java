...
public class MainCourseFoodFragment extends Fragment implements IOnListFood,ICartDatabase {
    ...
    public static MainCourseFoodFragment newInstance() {

        Bundle args = new Bundle();

        MainCourseFoodFragment fragment = new MainCourseFoodFragment();
...
//
        ...
        presenter.showListFood(IHelper.TAB_MAIN_COURSE);
