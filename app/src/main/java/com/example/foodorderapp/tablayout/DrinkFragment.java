...
public class DrinkFragment extends Fragment implements IOnListFood,ICartDatabase {
...
//
        ...
        presenter.showListFood(IHelper.TAB_DRINK);
    ...
    @Override
    public void onShowListFood(List<Food> drinkList) {

        foodAdapter = new ListFoodAdapter(drinkList, getContext());
